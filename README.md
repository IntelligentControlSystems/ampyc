...
| 2017 | Agrawal \& Sreenath | [Discrete control barrier functions for safety-critical control of discrete systems with application to bipedal robot navigation](https://roboticsproceedings.org/rss13/p73.pdf) | [code](https://github.com/IntelligentControlSystems/ampyc/blob/main/ampyc/controllers/ibsf.py) |
| 2018 | Wabersich \& Zeilinger | [Scalable synthesis of safety certificates from data with application to learning-based control](https://ieeexplore.ieee.org/abstract/document/8550288) | [code](https://github.com/IntelligentControlSystems/ampyc/blob/main/ampyc/controllers/ibsf.py) |
| 2018 | Wabersich \& Zeilinger | [Linear model predictive safety certification for learning-based control](https://ieeexplore.ieee.org/abstract/document/8619829) | [code](https://github.com/IntelligentControlSystems/ampyc/blob/main/ampyc/controllers/psf.py) |
